...
export class InformaciNPage {
  ...
  recicleItems=[
    {name:"Ordinarios",
     img:"assets/img/M6CJQp7QVKNBNmD5E8wG_reciclajeicono1.PNG",
    ...
    {name:"Papel Carton",
     img:"assets/img/1KRE9DF6RkSDajs0Vxd5_reciclajeicono2.PNG",
    ...
    {name:"Plástico",
     img:"assets/img/gvND9hycRAGzomvSLP9a_reciclajeicono3.PNG",
     info:`
